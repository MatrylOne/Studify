...
public class PhysicsScene: SCNScene {
    ...
    private func initScene(length: CGFloat){
        ...
        lightingEnvironment.contents = UIImage(named: "enviroment.jpg")
        lightingEnvironment.intensity = 1000
        background.contents = UIImage(named: "enviroment.jpg")
    ...
    private func createPhisical(length: CGFloat) -> SCNNode{
    ...
    private func createAnimation(time:Float, angle:Float) -> SCNAction{
...
var scene = PhysicsScene(length: 0.4)
